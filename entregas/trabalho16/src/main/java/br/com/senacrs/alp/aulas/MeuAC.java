...
import br.com.senacrs.alp.aulas.InterpretaStrings.TIPO_STRING;

public class MeuAC implements ArquivoConfiguracao {
	...
	MeuAC(String arquivoEntrada) {
		...
		LerArquivos leitorArqivo = new MeuLA();
		String[] chaves = null;
		...
		InterpretaStrings validador = new MeuIS();
